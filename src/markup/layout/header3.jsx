                        ...
                        <div class="auto-container">
                            <div class="inner-container">
                                ...
                                <div class="nav-outer clearfix">
                                    {/* <!--Logo--> */}
                                    <div class="logo-box">
                                        <div class="logo"><Link to={'/'}><img src={require('../../assets/images/essda.svg')} height={50} width={50} alt="" /></Link></div>
                                    </div>
                    ...
                    <div class={scrolled ? "sticky-header animated slideInDown" : "sticky-header"}>
                        <div class="auto-container clearfix">
                            ...
                            <div class="logo pull-left">
                                <Link to={'/'} title=""><img src={require('../../assets/images/essda.svg')} height={50} width={50} alt="" title="" /></Link>
                            </div>
                            {/* <!--Right Col--> */}
